...
\- **age**. Edat de la persona (1 = male; 0 = female)

\- **sex**. Sexe de la persona No indica res a l'origen del dataset,
però considerant que els homes es diagnostiquen més amb atacs de cor (o
en tenen més), considerem que 1 és home i 0 és dona
...
elevation or depression of \> 0.05 mV) Value 2: showing probable or
...
\- **output**. Target variable (0= less chance of heart attack 1= more
chance of heart attack) 0: \< 50% diameter narrowing. less chance of
heart disease 1: \> 50% diameter narrowing. more chance of heart disease
...
Pot ser el resultat d'addicionar diferents datasets o una subselecció
útil de les dades originals, en base a l'objectiu que es vulgui
aconseguir.
...
nivell d'especificitat de les dades, podem valorar que hi ha un registre
repetit.
...
Eliminem el registre repetit i conservarem la resta donat que tenim un
número de registres perfectement gestionable
...
Per tal valorar quins valors ens interessa utilitzar per fer l'anàlisi,
començarem fer una revisió de la distribució de cada una de les
variables
...
Aplicarem una anàlisi de components principals per tal valorar si podem
...
Tenim cuatre variables numèriques que ens pot interessar normalitzar per
...
nova comprovació per evitar errors d'apreciació
