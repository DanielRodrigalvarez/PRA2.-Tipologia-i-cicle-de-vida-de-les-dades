...
```
Apreciem que hi ha més informació d'homes que de dones i que el número de registres amb output igual a 1 és lleugerament superior al valor 0.
...
Donat que l'estudi es base en la diferència entre homes i dones, ens interessa comprobar quina informació tenim per cada grup
```{r}
...
```
Observem que tenim 207 homes i 96 dones i que la distribució del camp output dins de cada grup és diferent, tenint més pes en el valor 1 en dones que en homes.
